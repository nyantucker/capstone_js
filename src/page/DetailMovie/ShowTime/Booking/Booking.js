...
import { getDsPhongVe } from '../../../../service/api';
    ...
    let handleDanhSachGhe = () => { 
        return danhSachGhe.map((ghe) => { 
            if (ghe.loaiGhe == "Thuong") {
                ...
                return <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-4 border border-blue-700 rounded">{ghe.tenGhe}</button>
